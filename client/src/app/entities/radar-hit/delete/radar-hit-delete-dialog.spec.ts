...
import { RadarHitDeleteDialog } from './radar-hit-delete-dialog';

describe('RadarHit Management Delete Component', () => {
  let comp: RadarHitDeleteDialog;
  let fixture: ComponentFixture<RadarHitDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RadarHitDeleteDialog);

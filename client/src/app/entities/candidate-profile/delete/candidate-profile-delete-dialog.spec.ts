...
import { CandidateProfileDeleteDialog } from './candidate-profile-delete-dialog';

describe('CandidateProfile Management Delete Component', () => {
  let comp: CandidateProfileDeleteDialog;
  let fixture: ComponentFixture<CandidateProfileDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CandidateProfileDeleteDialog);

...
import { OfferPositioningDeleteDialog } from './offer-positioning-delete-dialog';

describe('OfferPositioning Management Delete Component', () => {
  let comp: OfferPositioningDeleteDialog;
  let fixture: ComponentFixture<OfferPositioningDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OfferPositioningDeleteDialog);

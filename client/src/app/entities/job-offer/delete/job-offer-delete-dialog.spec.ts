...
import { JobOfferDeleteDialog } from './job-offer-delete-dialog';

describe('JobOffer Management Delete Component', () => {
  let comp: JobOfferDeleteDialog;
  let fixture: ComponentFixture<JobOfferDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(JobOfferDeleteDialog);

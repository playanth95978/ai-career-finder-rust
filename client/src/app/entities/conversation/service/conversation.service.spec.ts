...
const requireRestSample: RestConversation = {
  ...
  lastMessageAt: sampleWithRequiredData.lastMessageAt?.toJSON(),
};
...
describe('Conversation Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Conversation', () => {
      ...
      service.create(conversation).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Conversation', () => {
      ...
      service.update(conversation).subscribe(resp => (expectedResult = resp));
    ...
    describe('addConversationToCollectionIfMissing', () => {
      it('should add a Conversation to an empty array', () => {
        ...
        expect(expectedResult).toEqual([conversation]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([conversation, conversation2]);
      });

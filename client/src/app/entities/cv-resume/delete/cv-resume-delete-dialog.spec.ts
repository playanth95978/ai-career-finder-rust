...
import { CvResumeDeleteDialog } from './cv-resume-delete-dialog';

describe('CvResume Management Delete Component', () => {
  let comp: CvResumeDeleteDialog;
  let fixture: ComponentFixture<CvResumeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CvResumeDeleteDialog);

...
import { RadarStateDeleteDialog } from './radar-state-delete-dialog';

describe('RadarState Management Delete Component', () => {
  let comp: RadarStateDeleteDialog;
  let fixture: ComponentFixture<RadarStateDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RadarStateDeleteDialog);

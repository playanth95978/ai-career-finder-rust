...
import { CvResumeVersionDeleteDialog } from './cv-resume-version-delete-dialog';

describe('CvResumeVersion Management Delete Component', () => {
  let comp: CvResumeVersionDeleteDialog;
  let fixture: ComponentFixture<CvResumeVersionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CvResumeVersionDeleteDialog);

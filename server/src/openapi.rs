...
#[openapi(
    ...
    paths(
        ...
        handlers::offer_tailored_resume::get_all,
                ...
                handlers::job_copilot_cv::update_profile,
                handlers::account::complete_onboarding,
                // Job Copilot : preferences
                handlers::job_copilot_preference::get_preferences,
                handlers::job_copilot_preference::update_preferences,
                // Job Copilot : opportunity radar
                handlers::job_copilot_radar::feed,
                handlers::job_copilot_radar::unread_count,
                handlers::job_copilot_radar::mark_seen,
                handlers::job_copilot_radar::dismiss,
                // Job Copilot : recherche et matching
                handlers::job_copilot_search::search,
                handlers::job_copilot_search::search_smart,
                handlers::job_copilot_search::indexed_count,
                handlers::job_copilot_search::match_jobs,
                handlers::job_copilot_search::match_advanced,
                handlers::job_copilot_search::search_by_criteria,
                handlers::job_copilot_search::fetch_from_url,
                handlers::job_copilot_search::enrich,
                // Job Copilot : candidatures
                handlers::job_copilot_application::get_applications,
                handlers::job_copilot_application::get_stats,
                handlers::job_copilot_application::create_application,
                handlers::job_copilot_application::update_status,
                handlers::job_copilot_application::update_cover_letter,
                handlers::job_copilot_application::generate_cover_letter,
                // CV Builder
                handlers::cv_builder::get_resume,
                handlers::cv_builder::save_resume,
                handlers::cv_builder::create_version,
                handlers::cv_builder::list_versions,
    ...
    components(
        schemas(
            ...
            // Job Copilot / CV Builder schemas
            JobOfferSummaryDto,
            MatchTagDto,
            MatchResultDto,
            OfferFacetsDto,
